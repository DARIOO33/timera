            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 border border-gray-100">
                ...
                <div className="relative aspect-square bg-gray-100 overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4">
                        <span className="bg-black/80 text-white text-xs font-medium px-3 py-1 rounded-full backdrop-blur-sm">
                            {product.collection}
                        </span>
                    </div>
                ...
                <div className="p-4">
                    ...
                    <div className="flex justify-center mt-4">
                        <button
                            ...
                            className="flex-1 group inline-flex items-center justify-center bg-black text-white px-6 py-3 rounded-lg font-medium hover:bg-gray-800 transition-all duration-300 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
                        >
