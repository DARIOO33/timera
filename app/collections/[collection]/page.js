...
export default async function CollectionPage({ params }) {
    ...
    const collectionData = {
        ...
        hommes: {
            ...
            description: 'Des montres masculines alliant robustesse et élégance, conçues pour accompagner les hommes dans toutes leurs activités quotidiennes et professionnelles.',
            image: 'https://images.unsplash.com/photo-1523170335258-f5ed11844a49?w=1200&auto=format&fit=crop'
        },
        femmes: {
            title: 'Collection Pour Femmes',
            description: 'Une sélection raffinée de montres féminines, alliant délicatesse et précision, pour sublimer chaque instant de la journée.',
            image: 'https://images.unsplash.com/photo-1547996160-81f58f6e6e68?w=1200&auto=format&fit=crop'
        }
    };
    ...
    return (
        <div className="min-h-screen bg-white">
            {/* Collection Hero */}
            <div className="relative bg-gradient-to-b from-[#0E2B1F] to-[#12362A] text-white">
                <div className="absolute inset-0 opacity-20">
                    <div className="absolute inset-0 bg-gradient-to-r from-[#0E2B1F]/80 to-transparent"></div>
                </div>
                <div className="container mx-auto px-4 py-16 lg:py-24 relative z-10">
                    <div className="max-w-3xl">
                        <div className="inline-flex items-center space-x-2 bg-[#D4AF37]/20 text-[#D4AF37] px-4 py-2 rounded-full mb-6 border border-[#D4AF37]/30">
                            <span className="text-sm font-medium tracking-wider">COLLECTION</span>
                        </div>
